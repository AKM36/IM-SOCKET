<template>
    <div class="msgbox-wrapper">
        <transition name="msgbox-bounce" @after-enter="show()" @after-leave="hide()">
            <div class="msgbox" v-show="open" ref="popup" :style="{'z-index': zIndex}">
                ...
                <div class="msgbox-btns">
                    <button :class="[ cancelButtonClasses ]" v-show="showCancelButton" @click="handleAction(false)">{{ cancelButtonText }}</button>
                    <button :class="[ confirmButtonClasses ]" v-show="showConfirmButton" @click="handleAction(true)">{{ confirmButtonText }}</button>
                </div>
            </div>
        </transition>
    </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      handleAction(action) {
        if (this.$type === "prompt" && action && !this.validate()) {
          return;
        }
      ...
      overlayClick() {
        ...
        if (this.closeOnClickModal) this.open = false;
      },
